...
ssh -o BatchMode=yes jiangzhuo@192.168.1.15 "cd ~/sokuji-webgpu-spike && venv/bin/python run_page.py '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome' '$URL' 1200 --unsafely-treat-insecure-origin-as-secure=$GB10" > "page-mac-$label.log" 2>&1
