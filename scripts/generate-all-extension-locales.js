...
const englishTranslations = {
  extensionName: 'GM MeetMind - AI-powered Live Speech Translation for Online Meetings',
  ...
  popupTitle: 'GM MeetMind - Supported Sites',
  openSokuji: 'Open GM MeetMind',
  chromeWebStore: 'Chrome Web Store',
  sokujiAvailable: '✓ GM MeetMind is available on $SITE_NAME$!',
  clickToStart: 'Click "Open GM MeetMind" below to start real-time translation.',
  ...
  currentlyOn: 'Currently on $HOSTNAME$. GM MeetMind works on these platforms:',
...
const specificTranslations = {
  'ar': {
    extensionName: 'GM MeetMind - ترجمة الكلام المباشر بالذكاء الاصطناعي للاجتماعات الإلكترونية',
    ...
    popupTitle: 'GM MeetMind - المواقع المدعومة',
    openSokuji: 'فتح GM MeetMind',
    chromeWebStore: 'متجر Chrome الإلكتروني',
    sokujiAvailable: '✓ GM MeetMind متاح على $SITE_NAME$!',
    clickToStart: 'انقر على "فتح GM MeetMind" أدناه لبدء الترجمة في الوقت الفعلي.',
    ...
    currentlyOn: 'حالياً على $HOSTNAME$. GM MeetMind يعمل على هذه المنصات:',
  ...
  'zh_CN': {
    extensionName: 'GM MeetMind - AI驱动的在线会议实时语音翻译',
    extensionDescription: 'AI驱动的即时语音翻译，适用于所有视频会议。通过实时语音翻译打破语言障碍。',
    popupTitle: 'GM MeetMind - 支持的网站',
    openSokuji: '打开 GM MeetMind',
    chromeWebStore: 'Chrome 网上应用店',
    sokujiAvailable: '✓ GM MeetMind 在 $SITE_NAME$ 上可用！',
    clickToStart: '点击下方的"打开 GM MeetMind"开始实时翻译。',
    quickStart: '快速开始：',
    quickStartInstructions: '配置您的 OpenAI API 密钥 ← 选择"Sokuji_Virtual_Mic"作为麦克风 ← 开始说话！',
    notSupported: '⚠ 此网站不支持',
    currentlyOn: '当前在 $HOSTNAME$。GM MeetMind 支持这些平台：',
  ...
  'es': {
    extensionName: 'GM MeetMind - Traducción de Voz en Vivo con IA para Reuniones Online',
    ...
    popupTitle: 'GM MeetMind - Sitios Compatibles',
    openSokuji: 'Abrir GM MeetMind',
    chromeWebStore: 'Chrome Web Store',
    sokujiAvailable: '✓ ¡GM MeetMind está disponible en $SITE_NAME$!',
    clickToStart: 'Haz clic en "Abrir GM MeetMind" a continuación para comenzar la traducción en tiempo real.',
    ...
    currentlyOn: 'Actualmente en $HOSTNAME$. GM MeetMind funciona en estas plataformas:',
  ...
  'fr': {
    extensionName: 'GM MeetMind - Traduction Vocale en Direct par IA pour Réunions en Ligne',
    ...
    popupTitle: 'GM MeetMind - Sites Pris en Charge',
    openSokuji: 'Ouvrir GM MeetMind',
    chromeWebStore: 'Chrome Web Store',
    sokujiAvailable: '✓ GM MeetMind est disponible sur $SITE_NAME$ !',
    clickToStart: 'Cliquez sur "Ouvrir GM MeetMind" ci-dessous pour commencer la traduction en temps réel.',
    ...
    currentlyOn: 'Actuellement sur $HOSTNAME$. GM MeetMind fonctionne sur ces plateformes :',
  ...
  'ja': {
    extensionName: 'GM MeetMind - オンライン会議用AI音声翻訳',
    extensionDescription: 'すべてのビデオ会議用のAI音声翻訳。リアルタイム音声翻訳で言語の壁を破る。',
    popupTitle: 'GM MeetMind - 対応サイト',
    openSokuji: 'GM MeetMindを開く',
    chromeWebStore: 'Chrome ウェブストア',
    sokujiAvailable: '✓ GM MeetMindは$SITE_NAME$で利用可能です！',
    clickToStart: 'リアルタイム翻訳を開始するには、下の「GM MeetMindを開く」をクリックしてください。',
    quickStart: 'クイックスタート：',
    quickStartInstructions: 'OpenAI APIキーを設定 ← マイクとして「Sokuji_Virtual_Mic」を選択 ← 話し始める！',
    notSupported: '⚠ このサイトではサポートされていません',
    currentlyOn: '現在$HOSTNAME$にいます。GM MeetMindはこれらのプラットフォームで動作します：',
