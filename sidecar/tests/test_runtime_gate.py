...
per SKU, pinned to the native-v1.2.0 GitHub Release, gated by sys_platform/
...
NATIVE_RELEASE_BASE = (
    "https://github.com/kizuna-ai-lab/sokuji/releases/download/native-v1.2.0/"
)
...
NATIVE_WHEELS = {
    "sokuji_native-1.2.0-py3-none-manylinux_2_35_x86_64.whl":
        'sys_platform == "linux" and platform_machine == "x86_64"',
    "sokuji_native-1.2.0-py3-none-manylinux_2_35_aarch64.whl":
        'sys_platform == "linux" and platform_machine == "aarch64"',
    "sokuji_native-1.2.0-py3-none-win_amd64.whl":
        'sys_platform == "win32" and platform_machine == "AMD64"',
    "sokuji_native-1.2.0-py3-none-macosx_11_0_arm64.whl":
        'sys_platform == "darwin" and platform_machine == "arm64"',
    "sokuji_native-1.2.0-py3-none-macosx_11_0_x86_64.whl":
...
def test_base_requirements_is_the_seven_pypi_plus_five_native_wheel_end_state():
    ...
    # direct-URL lines (one per SKU) pinned to the native-v1.2.0 release and
