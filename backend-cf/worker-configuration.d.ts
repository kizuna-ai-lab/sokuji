/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8acece9cad90d282f443e7016dfb8bd1)
...
declare namespace Cloudflare {
	interface Env {
		...
		PALABRA_API_KEY: string;
		ADMIN_USER_IDS: string;
		REALTIME_RELAY: DurableObjectNamespace<import("./src/index").RealtimeRelayDurableObject>;
		DB: D1Database;
	}
}
