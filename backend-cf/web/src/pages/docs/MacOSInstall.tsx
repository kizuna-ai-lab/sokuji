 ...
 * Completely synced with docs/tutorials/macos-install.html
 */
...
// Types for the macOS install data structure
...
// Translations object - exactly matching macos-install.html
const translations: Record<string, MacOSInstallData> = {
  en: {
...
export function MacOSInstall() {
  ...
  return (
    <div className="docs-content install-page">
      ...
      >
        <Download size={20} />
        {currentLang === 'zh' ? '下载 macOS 版本' :
         currentLang === 'ja' ? 'macOS版をダウンロード' :
         currentLang === 'ko' ? 'macOS용 다운로드' :
         'Download for macOS'}
