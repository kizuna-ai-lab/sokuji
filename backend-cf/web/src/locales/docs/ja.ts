...
const ja: Record<string, string> = {
  ...
  'dashboard.nav.profile': 'プロフィール',
  'dashboard.nav.security': 'セキュリティ',
  'dashboard.nav.feedback': 'フィードバック',
  'dashboard.nav.signOut': 'ログアウト',
  'dashboard.user.fallback': 'ユーザー',

  // Dashboard Home
  'dashboard.home.welcomeBack': 'おかえりなさい、{name}さん',
  'dashboard.home.subtitle': 'アカウント設定と環境設定を管理',
  'dashboard.home.accountOverview': 'アカウント概要',
  'dashboard.home.accountStatus': 'アカウントステータス',
  'dashboard.home.accountDetails': 'アカウント詳細',
  'dashboard.home.quickActions': 'クイックアクション',
  'dashboard.home.name': '名前',
  'dashboard.home.email': 'メールアドレス',
  'dashboard.home.emailVerified': 'メール認証',
  'dashboard.home.accountType': 'アカウントタイプ',
  'dashboard.home.userId': 'ユーザーID',
  'dashboard.home.created': '作成日',
  'dashboard.home.lastUpdated': '最終更新',
  'dashboard.home.notSet': '未設定',
  'dashboard.home.verified': '認証済み',
  'dashboard.home.notVerified': '未認証',
  'dashboard.home.anonymous': '匿名',
  'dashboard.home.registered': '登録済み',
  'dashboard.home.editProfile': 'プロフィールを編集',
  'dashboard.home.securitySettings': 'セキュリティ設定',
  'dashboard.home.na': 'N/A',

  // Dashboard Profile
  'dashboard.profile.title': 'プロフィール設定',
  'dashboard.profile.subtitle': '個人情報を管理',
  'dashboard.profile.personalInfo': '個人情報',
  'dashboard.profile.personalInfoDesc': '名前と基本情報を更新',
  'dashboard.profile.nameLabel': '名前',
  'dashboard.profile.namePlaceholder': 'お名前',
  'dashboard.profile.saveChanges': '変更を保存',
  'dashboard.profile.profileUpdated': 'プロフィールが更新されました',
  'dashboard.profile.emailAddress': 'メールアドレス',
  'dashboard.profile.emailAddressDesc': 'メールアドレスと認証状態を管理',
  'dashboard.profile.currentEmail': '現在のメールアドレス',
  'dashboard.profile.verified': '認証済み',
  'dashboard.profile.notVerified': '未認証',
  'dashboard.profile.resendVerification': '認証メールを再送信',
  'dashboard.profile.verificationSent': '認証メールを送信しました！受信トレイをご確認ください。',
  'dashboard.profile.changeEmailTitle': 'メールアドレスの変更',
  'dashboard.profile.newEmailLabel': '新しいメールアドレス',
  'dashboard.profile.newEmailPlaceholder': 'new@email.com',
  'dashboard.profile.newEmailHint': '新しいアドレスに認証メールが送信されます',
  'dashboard.profile.changeEmail': 'メールアドレスを変更',
  'dashboard.profile.emailChangeSent': '新しいメールアドレスに認証メールを送信しました。ご確認ください。',

  // Dashboard Security
  'dashboard.security.title': 'セキュリティ設定',
  'dashboard.security.subtitle': 'パスワードとアカウントセキュリティを管理',
  'dashboard.security.changePassword': 'パスワードを変更',
  'dashboard.security.changePasswordDesc': 'アカウントを安全に保つためにパスワードを更新',
  'dashboard.security.currentPassword': '現在のパスワード',
  'dashboard.security.currentPasswordPlaceholder': '現在のパスワードを入力',
  'dashboard.security.newPassword': '新しいパスワード',
  'dashboard.security.newPasswordPlaceholder': '8文字以上',
  'dashboard.security.confirmPassword': '新しいパスワードを確認',
  'dashboard.security.confirmPasswordPlaceholder': '新しいパスワードを確認',
  'dashboard.security.changePasswordBtn': 'パスワードを変更',
  'dashboard.security.activeSessions': 'アクティブセッション',
  'dashboard.security.activeSessionsDesc': 'アクティブなログインセッションを管理（{count}件アクティブ）',
  'dashboard.security.current': '現在',
  'dashboard.security.lastActive': '最終アクティブ：{time}',
  'dashboard.security.loadingSessions': 'セッションを読み込み中...',
  'dashboard.security.signOutOther': '他のすべてのセッションをログアウト',
  'dashboard.security.deleteAccount': 'アカウントを削除',
  'dashboard.security.deleteAccountDesc': 'アカウントと関連するすべてのデータを完全に削除',
  'dashboard.security.deleteWarning': 'この操作は取り消せません。すべてのデータが完全に削除されます。',
  'dashboard.security.deleteBtn': 'アカウントを削除',
  'dashboard.security.deleteConfirmText': '削除を確認するには、下にDELETEと入力してください：',
  'dashboard.security.deleteConfirmPlaceholder': 'DELETEと入力して確認',
  'dashboard.security.cancel': 'キャンセル',
  'dashboard.security.anonymousNote': '匿名アカウントはパスワードを変更できません。まず正式なアカウントに変換してください。',
  'dashboard.security.passwordMinLength': '新しいパスワードは8文字以上である必要があります',
  'dashboard.security.passwordMismatch': 'パスワードが一致しません',
  'dashboard.security.passwordIncorrect': '現在のパスワードが正しくありません',
  'dashboard.security.passwordSuccess': 'パスワードが変更されました。他のセッションはログアウトされました。',
  'dashboard.security.typeDelete': 'DELETEと入力して確認してください',

  // Dashboard Feedback
  'dashboard.feedback.title': 'フィードバックを送信',
  'dashboard.feedback.subtitle': 'バグ報告、機能提案、ご意見をお聞かせください。すべてのメッセージを読んでいます！',
  'dashboard.feedback.yourFeedback': 'フィードバック',
  'dashboard.feedback.sendingAs': '送信者：{email}',
  'dashboard.feedback.remainingCount': '本日の残り送信可能数：{remaining}/{limit}件',
  'dashboard.feedback.limitReached': '本日の上限に達しました。明日また送信できます。',
  'dashboard.feedback.feedbackType': 'フィードバックの種類',
  'dashboard.feedback.bugReport': 'バグ報告',
  'dashboard.feedback.bugReportDesc': '問題や不具合を報告',
  'dashboard.feedback.suggestion': '機能提案',
  'dashboard.feedback.suggestionDesc': '新機能や改善を提案',
  'dashboard.feedback.other': 'その他',
  'dashboard.feedback.otherDesc': '一般的なフィードバックや質問',
  'dashboard.feedback.message': 'メッセージ',
  'dashboard.feedback.messagePlaceholder': 'フィードバックの詳細を記述してください...',
  'dashboard.feedback.messageHint': '{count}/5000文字（最低10文字）',
  'dashboard.feedback.sendFeedback': 'フィードバックを送信',
  'dashboard.feedback.verificationRequired': 'メール認証が必要です',
