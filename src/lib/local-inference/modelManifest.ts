...
export const MODEL_MANIFEST: ModelManifestEntry[] = [
  ...
  { id: 'opus-mt-jap-en', type: 'translation', name: 'Opus-MT (jap → en)', languages: ['ja', 'en'], files: translationFiles(1_377, 293, 5_068_572, 281, 43_312_542, 50_550_704), hfModelId: 'Xenova/opus-mt-jap-en', sourceLang: 'jap', targetLang: 'en' },
