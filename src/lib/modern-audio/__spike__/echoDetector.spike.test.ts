/**
 * SPIKE THROWAWAY — parameter sweep for the echo-detection probe.
 *
...
import { buildScene, SAMPLE_RATE, type Scene, type SceneKind, type SceneParams } from './signalSim';
